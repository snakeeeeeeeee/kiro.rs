...
fn runtime_settings_pairs(
    ...
    Ok(vec![
        ...
        (
            "opus47DetectionProfile",
            settings.opus47_detection_profile.clone(),
        ),
        (
...
fn apply_runtime_setting(
    ...
    match key {
        ...
        "opus47DetectionProfile" => {
            settings.opus47_detection_profile = normalize_opus47_detection_profile(value)
        }
        "opus47SignedThinkingPreservation" => {
        ...
        "virtualCacheContextShrinkResetRatio" => {
            settings.virtual_cache_context_shrink_reset_ratio = parse_f64(key, value)?
        }
